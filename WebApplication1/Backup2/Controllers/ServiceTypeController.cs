...
namespace WebApplication1.Controllers
{
    ...
    public class ServiceTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ServiceTypeId,ServiceTypeName,PricePerUnit,Description")] ServiceType serviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ServiceTypeId,ServiceTypeName,PricePerUnit,Description")] ServiceType serviceType)
        {
            if (ModelState.IsValid)
            {
                db.Entry(serviceType).State = EF::System.Data.Entity.EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(serviceType);
